 ...
 ?> 
    <div id="content" class="p-4 p-md-5 pt-5">
     <div class="card-group">
       <div class="card">
         <div class="card-body">
           <h4 class="card-title">Checking Status</h4>
           <form  class="register active"  method="post" action="check.php">
<?php include('errors.php'); ?>
            
            <input type="hidden" id="ID" name="ID" value="<?php echo $row['id'];?>"  placeholder="ID" required>
  <div class="form-group">
    <label for="exampleInputEmail1">Enter Id Number</label>
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" placeholder="Phone Number" name="phnno">
  </div>
  <button type="submit" class="btn btn-primary" name="check_user">Check From List</button>
</form>
         </div>
       </div>
     </div>
